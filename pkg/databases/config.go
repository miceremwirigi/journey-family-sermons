...
func LoadTestDatabaseConfig() (env, db_host, db_user, db_pass, test_db_name, db_ssl, db_port string, err error) {
	...
	test_db_name, set = os.LookupEnv("test_db_name")
	if !set {
	...
	return env, db_host, db_user, db_pass, test_db_name, db_ssl, db_port, nil
}

func LoadDatabaseConfig() (env, db_host, db_user, db_pass, db_name, db_ssl, db_port string, err error) {
